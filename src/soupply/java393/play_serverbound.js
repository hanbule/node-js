...
const PlayServerbound = {
  ...
  QueryBlockNbt: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "QueryBlockNbt(transationId: " + this.transationId + ", location: " + this.location + ")";
    }
  ...
  TabComplete: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "TabComplete(transactionId: " + this.transactionId + ", text: " + this.text + ")";
    }
  ...
  EditBook: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "EditBook(newBook: " + this.newBook + ", signing: " + this.signing + ")";
    }
  ...
  QueryEntityNbt: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "QueryEntityNbt(transactionId: " + this.transactionId + ", entityId: " + this.entityId + ")";
    }
  ...
  PickItem: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "PickItem(slot: " + this.slot + ")";
    }
  ...
  RecipeBookData: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "RecipeBookData(type: " + this.type + ")";
    }
  ...
  NameItem: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "NameItem(itemName: " + this.itemName + ")";
    }
  ...
  SelectTrade: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "SelectTrade(selectedSlot: " + this.selectedSlot + ")";
    }
  ...
  SetBeaconEffect: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "SetBeaconEffect(primaryEffect: " + this.primaryEffect + ", secondaryEffect: " + this.secondaryEffect + ")";
    }
  ...
  UpdateCommandBlock: class extends Packet {
    ...
    // mode
    static get SEQUENCE(){ return 0; };
    static get AUTO(){ return 1; };
    static get REDSTONE(){ return 2; };

    // flags
    static get TRACK_OUTPUT(){ return 1; };
    static get CONDITIONAL(){ return 2; };
    static get AUTOMATIC(){ return 4; };
    ...
    /** @return {string} */
    toString() {
      return "UpdateCommandBlock(location: " + this.location + ", command: " + this.command + ", mode: " + this.mode + ", flags: " + this.flags + ")";
    }
  ...
  UpdateCommandBlockMinecart: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "UpdateCommandBlockMinecart(entityId: " + this.entityId + ", command: " + this.command + ", trackOutput: " + this.trackOutput + ")";
    }
  ...
  UpdateStructureBlock: class extends Packet {
    ...
    // action
    static get UPDATE_DATA(){ return 0; };
    static get SAVE_STRUCTURE(){ return 1; };
    static get LOAD_STRUCTURE(){ return 2; };
    static get DETECT_SIZE(){ return 3; };

    // mode
    static get SAVE(){ return 0; };
    static get LOAD(){ return 1; };
    static get CORNER(){ return 2; };
    static get DATA(){ return 3; };

    // mirror
    static get NONE(){ return 0; };
    static get LEFT_RIGHT(){ return 1; };
    static get FRONT_BACK(){ return 2; };

    // rotation
    static get CLOCKWISE_90(){ return 1; };
    static get CLOCKWISE_180(){ return 2; };
    static get COUNTERCLOCKWISE_90(){ return 3; };

    // flags
    static get IGNORE_ENTITIES(){ return 1; };
    static get SHOW_AIR(){ return 2; };
    static get SHOW_BOUNDING_BOX(){ return 4; };
    ...
    /** @return {string} */
    toString() {
      return "UpdateStructureBlock(location: " + this.location + ", action: " + this.action + ", mode: " + this.mode + ", offset: " + this.offset + ", size: " + this.size + ", mirror: " + this.mirror + ", rotation: " + this.rotation + ", metadata: " + this.metadata + ", integrity: " + this.integrity + ", speed: " + this.speed + ", flags: " + this.flags + ")";
    }
