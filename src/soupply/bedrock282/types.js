...
const Types = {
  ...
  PackWithSize: class extends Buffer {
    ...
    /** @return {string} */
    toString() {
      return "PackWithSize(id: " + this.id + ", version: " + this.version + ", size: " + this.size + ", unknown3: " + this.unknown3 + ", unknown4: " + this.unknown4 + ")";
    }
  ...
  Pack: class extends Buffer {
    ...
    /** @return {string} */
    toString() {
      return "Pack(id: " + this.id + ", version: " + this.version + ", unknown2: " + this.unknown2 + ")";
    }
  ...
  Attribute: class extends Buffer {
    ...
    /** @return {string} */
    toString() {
      return "Attribute(min: " + this.min + ", max: " + this.max + ", value: " + this.value + ", default_: " + this.default_ + ", name: " + this.name + ")";
    }
  ...
  Varulong: class extends Buffer {
    ...
    /** @return {string} */
    toString() {
      return "Varulong(name: " + this.name + ", data: " + this.data + ")";
    }
  ...
  Parameter: class extends Buffer {
    ...
    static get VALUE(){ return 3; };
    static get WILDCARD_INT(){ return 4; };
    static get TARGET(){ return 5; };
    static get WILDCARD_TARGET(){ return 6; };
    static get STRING(){ return 15; };
    static get POSITION(){ return 16; };
    static get MESSAGE(){ return 19; };
    static get RAWTEXT(){ return 21; };
    static get JSON(){ return 24; };
    static get COMMAND(){ return 30; };
  ...
  CommandOriginData: class extends Buffer {
    ...
    static get BLOCK(){ return 1; };
    static get MINECART_BLOCK(){ return 2; };
    static get DEV_CONSOLE(){ return 3; };
    static get TEST(){ return 4; };
    static get AUTOMATION_PLAYER(){ return 5; };
    static get CLIENT_AUTOMATION(){ return 6; };
    static get DEDICATED_SERVER(){ return 7; };
    static get ENTITY(){ return 8; };
    static get VIRTUAL(){ return 9; };
    static get GAME_ARGUMENT(){ return 10; };
    static get ENTITY_SERVER(){ return 11; };
    ...
    /** @return {string} */
    toString() {
      return "CommandOriginData(type: " + this.type + ", uuid: " + this.uuid + ", requestId: " + this.requestId + ", unknown3: " + this.unknown3 + ")";
    }
  ...
  CommandMessage: class extends Buffer {
    ...
    /** @return {string} */
    toString() {
      return "CommandMessage(isInternal: " + this.isInternal + ", messageId: " + this.messageId + ", parameters: " + this.parameters + ")";
    }
  ...
  Score: class extends Buffer {
    ...
    /** @return {string} */
    toString() {
      return "Score(uuid: " + this.uuid + ", objectiveName: " + this.objectiveName + ", score: " + this.score + ")";
    }
  ...
  RegisterEntry: class extends Buffer {
    ...
    /** @return {string} */
    toString() {
      return "RegisterEntry(scoreboardId: " + this.scoreboardId + ", uuid: " + this.uuid + ")";
    }
