 ...
 * Generated from data/bedrock282.xml
 */
...
const Play = {
  ...
  PlayStatus: class extends Packet {
    ...
    static get SERVER_FULL(){ return 7; };
  ...
  StartGame: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "StartGame(entityId: " + this.entityId + ", runtimeId: " + this.runtimeId + ", gamemode: " + this.gamemode + ", position: " + this.position + ", yaw: " + this.yaw + ", pitch: " + this.pitch + ", seed: " + this.seed + ", dimension: " + this.dimension + ", generator: " + this.generator + ", worldGamemode: " + this.worldGamemode + ", difficulty: " + this.difficulty + ", spawnPosition: " + this.spawnPosition + ", loadedInCreative: " + this.loadedInCreative + ", time: " + this.time + ", version: " + this.version + ", eduFeaturesEnabled: " + this.eduFeaturesEnabled + ", rainLevel: " + this.rainLevel + ", lightningLevel: " + this.lightningLevel + ", multiplayerGame: " + this.multiplayerGame + ", broadcastToLan: " + this.broadcastToLan + ", broadcastToXbl: " + this.broadcastToXbl + ", commandsEnabled: " + this.commandsEnabled + ", textureRequired: " + this.textureRequired + ", gameRules: " + this.gameRules + ", hasBonusChestEnabled: " + this.hasBonusChestEnabled + ", hasStartWithMapEnabled: " + this.hasStartWithMapEnabled + ", hasTrustPlayersEnabled: " + this.hasTrustPlayersEnabled + ", defaultPermissionLevel: " + this.defaultPermissionLevel + ", xboxLiveBroadcastMode: " + this.xboxLiveBroadcastMode + ", serverChunkTickRadius: " + this.serverChunkTickRadius + ", hasPlatformBroadcast: " + this.hasPlatformBroadcast + ", platformBroadcastMode: " + this.platformBroadcastMode + ", xboxLiveBroadcastIntent: " + this.xboxLiveBroadcastIntent + ", hasLockedBehaviorPack: " + this.hasLockedBehaviorPack + ", hasLockedResourcePack: " + this.hasLockedResourcePack + ", isFromLockedWorldTemplate: " + this.isFromLockedWorldTemplate + ", levelId: " + this.levelId + ", worldName: " + this.worldName + ", premiumWorldTemplate: " + this.premiumWorldTemplate + ", isTrial: " + this.isTrial + ", currentTick: " + this.currentTick + ", enchantmentSeed: " + this.enchantmentSeed + ", runtimeIdTable: " + this.runtimeIdTable + ", multiplayerCorrelationId: " + this.multiplayerCorrelationId + ")";
    }
  ...
  AddEntity: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "AddEntity(entityId: " + this.entityId + ", runtimeId: " + this.runtimeId + ", type: " + this.type + ", position: " + this.position + ", motion: " + this.motion + ", pitch: " + this.pitch + ", yaw: " + this.yaw + ", headYaw: " + this.headYaw + ", attributes: " + this.attributes + ", metadata: " + this.metadata + ", links: " + this.links + ")";
    }
  ...
  MoveEntityAbsolute: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "MoveEntityAbsolute(entityId: " + this.entityId + ", flags: " + this.flags + ", position: " + this.position + ", rotation: " + this.rotation + ")";
    }
  ...
  UpdateBlock: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "UpdateBlock(position: " + this.position + ", block: " + this.block + ", flagsAndMeta: " + this.flagsAndMeta + ", dataLayerId: " + this.dataLayerId + ")";
    }
  ...
  LevelSoundEvent: class extends Packet {
    ...
    static get MOB_ARMOR_STAND_PLACE(){ return 38; };
    static get ADD_CHEST(){ return 39; };
    static get THROW(){ return 40; };
    static get ATTACK(){ return 41; };
    static get ATTACK_NODAMAGE(){ return 42; };
    static get ATTACK_STRONG(){ return 43; };
    static get WARN(){ return 44; };
    static get SHEAR(){ return 45; };
    static get MILK(){ return 46; };
    static get THUNDER(){ return 47; };
    static get EXPLODE(){ return 48; };
    static get FIRE(){ return 49; };
    static get IGNITE(){ return 50; };
    static get FUSE(){ return 51; };
    static get STARE(){ return 52; };
    static get SPAWN(){ return 53; };
    static get SHOOT(){ return 54; };
    static get BREAK_BLOCK(){ return 55; };
    static get LAUNCH(){ return 56; };
    static get BLAST(){ return 57; };
    static get LARGE_BLAST(){ return 58; };
    static get TWINKLE(){ return 59; };
    static get REMEDY(){ return 60; };
    static get UNFECT(){ return 61; };
    static get LEVELUP(){ return 62; };
    static get BOW_HIT(){ return 63; };
    static get BULLET_HIT(){ return 64; };
    static get EXTINGUISH_FIRE(){ return 65; };
    static get ITEM_FIZZ(){ return 66; };
    static get CHEST_OPEN(){ return 67; };
    static get CHEST_CLOSED(){ return 68; };
    static get SHULKERBOX_OPEN(){ return 69; };
    static get SHULKERBOX_CLOSED(){ return 70; };
    static get ENDERCHEST_OPEN(){ return 71; };
    static get ENDERCHEST_CLOSED(){ return 72; };
    static get POWER_ON(){ return 73; };
    static get POWER_OFF(){ return 74; };
    static get ATTACH(){ return 75; };
    static get DETACH(){ return 76; };
    static get DENY(){ return 77; };
    static get TRIPOD(){ return 78; };
    static get POP(){ return 79; };
    static get DROP_SLOT(){ return 80; };
    static get NOTE(){ return 81; };
    static get THORNS(){ return 82; };
    static get PISTON_IN(){ return 83; };
    static get PISTON_OUT(){ return 84; };
    static get PORTAL(){ return 85; };
    static get WATER(){ return 86; };
    static get LAVA_POP(){ return 87; };
    static get LAVA(){ return 88; };
    static get BURP(){ return 89; };
    static get BUCKET_FILL_WATER(){ return 90; };
    static get BUCKET_FILL_LAVA(){ return 91; };
    static get BUCKET_EMPTY_WATER(){ return 92; };
    static get BUCKET_EMPTY_LAVA(){ return 93; };
    static get ARMOR_EQUIP_CHAIN(){ return 94; };
    static get ARMOR_EQUIP_DIAMOND(){ return 95; };
    static get ARMOR_EQUIP_GENERIC(){ return 96; };
    static get ARMOR_EQUIP_GOLD(){ return 97; };
    static get ARMOR_EQUIP_IRON(){ return 98; };
    static get ARMOR_EQUIP_LEATHER(){ return 99; };
    static get ARMOR_EQUIP_ELYTRA(){ return 100; };
    static get RECORD_13(){ return 101; };
    static get RECORD_CAT(){ return 102; };
    static get RECORD_BLOCKS(){ return 103; };
    static get RECORD_CHIRP(){ return 104; };
    static get RECORD_FAR(){ return 105; };
    static get RECORD_MALL(){ return 106; };
    static get RECORD_MELLOHI(){ return 107; };
    static get RECORD_STAL(){ return 108; };
    static get RECORD_STRAD(){ return 109; };
    static get RECORD_WARD(){ return 110; };
    static get RECORD_11(){ return 111; };
    static get RECORD_WAIT(){ return 112; };
    static get STOP_RECORD(){ return 113; };
    static get FLOP(){ return 114; };
    static get ELDERGUARDIAN_CURSE(){ return 115; };
    static get MOB_WARNING(){ return 116; };
    static get MOB_WARNING_BABY(){ return 117; };
    static get TELEPORT(){ return 118; };
    static get SHULKER_OPEN(){ return 119; };
    static get SHULKER_CLOSE(){ return 120; };
    static get HAGGLE(){ return 121; };
    static get HAGGLE_YES(){ return 122; };
    static get HAGGLE_NO(){ return 123; };
    static get HAGGLE_IDLE(){ return 124; };
    static get CHORUSGROW(){ return 125; };
    static get CHORUSDEATH(){ return 126; };
    static get GLASS(){ return 127; };
    static get POTION_BREWED(){ return 128; };
    static get CAST_SPELL(){ return 129; };
    static get PREPARE_ATTACK(){ return 130; };
    static get PREPARE_SUMMON(){ return 131; };
    static get PREPARE_WOLOLO(){ return 132; };
    static get FANG(){ return 133; };
    static get CHARGE(){ return 134; };
    static get CAMERA_TAKE_PICTURE(){ return 135; };
    static get LEASHKNOT_PLACE(){ return 136; };
    static get LEASHKNOT_BREAK(){ return 137; };
    static get GROWL(){ return 138; };
    static get WHINE(){ return 139; };
    static get PANT(){ return 140; };
    static get PURR(){ return 141; };
    static get PURREOW(){ return 142; };
    static get DEATH_MIN_VOLUME(){ return 143; };
    static get DEATH_MID_VOLUME(){ return 144; };
    static get IMITATE_BLAZE(){ return 145; };
    static get IMITATE_CAVE_SPIDER(){ return 146; };
    static get IMITATE_CREEPER(){ return 147; };
    static get IMITATE_ELDER_GUARDIAN(){ return 148; };
    static get IMITATE_ENDER_DRAGON(){ return 149; };
    static get IMITATE_ENDERMAN(){ return 150; };
    static get IMITATE_EVOCATION_ILLAGER(){ return 152; };
    static get IMITATE_GHAST(){ return 153; };
    static get IMITATE_HUSK(){ return 154; };
    static get IMITATE_ILLUSION_ILLAGER(){ return 155; };
    static get IMITATE_MAGMA_CUBE(){ return 156; };
    static get IMITATE_POLAR_BEAR(){ return 157; };
    static get IMITATE_SHULKER(){ return 158; };
    static get IMITATE_SILVERFISH(){ return 159; };
    static get IMITATE_SKELETON(){ return 160; };
    static get IMITATE_SLIME(){ return 161; };
    static get IMITATE_SPIDER(){ return 162; };
    static get IMITATE_STRAY(){ return 163; };
    static get IMITATE_VEX(){ return 164; };
    static get IMITATE_VINDICATION_ILLAGER(){ return 165; };
    static get IMITATE_WITCH(){ return 166; };
    static get IMITATE_WITHER(){ return 167; };
    static get IMITATE_WITHER_SKELETON(){ return 168; };
    static get IMITATE_WOLF(){ return 169; };
    static get IMITATE_ZOMBIE(){ return 170; };
    static get IMITATE_ZOMBIE_PIGMAN(){ return 171; };
    static get IMITATE_ZOMBIE_VILLAGER(){ return 172; };
    static get BLOCK_END_PORTAL_FRAME_FILL(){ return 173; };
    static get BLOCK_END_PORTAL_SPAWN(){ return 174; };
    static get RANDOM_ANVIL_USE(){ return 175; };
    static get BOTTLE_DRAGONBREATH(){ return 176; };
    static get PORTAL_TRAVEL(){ return 177; };
    static get ITEM_TRIDENT_HIT(){ return 178; };
    static get ITEM_TRIDENT_RETURN(){ return 179; };
    static get ITEM_TRIDENT_RIPTIDE_1(){ return 180; };
    static get ITEM_TRIDENT_RIPTIDE_2(){ return 181; };
    static get ITEM_TRIDENT_RIPTIDE_3(){ return 182; };
    static get ITEM_TRIDENT_THROW(){ return 183; };
    static get ITEM_TRIDENT_THUNDER(){ return 184; };
    static get ITEM_TRIDENT_HIT_GROUND(){ return 185; };
    static get DEFAULT(){ return 186; };
    static get ELEMCONSTRUCT_OPEN(){ return 188; };
    static get ICEBOMB_HIT(){ return 189; };
    static get BALLOONPOP(){ return 190; };
    static get LT_REACTION_ICEBOMB(){ return 191; };
    static get LT_REACTION_BLEACH(){ return 192; };
    static get LT_REACTION_EPASTE(){ return 193; };
    static get LT_REACTION_EPASTE2(){ return 194; };
    static get LT_REACTION_FERTILIZER(){ return 199; };
    static get LT_REACTION_FIREBALL(){ return 200; };
    static get LT_REACTION_MGSALT(){ return 201; };
    static get LT_REACTION_MISCFIRE(){ return 202; };
    static get LT_REACTION_FIRE(){ return 203; };
    static get LT_REACTION_MISCEXPLOSION(){ return 204; };
    static get LT_REACTION_MISCMYSTICAL(){ return 205; };
    static get LT_REACTION_MISCMYSTICAL2(){ return 206; };
    static get LT_REACTION_PRODUCT(){ return 207; };
    static get SPARKLER_USE(){ return 208; };
    static get GLOWSTICK_USE(){ return 209; };
    static get SPARKLER_ACTIVE(){ return 210; };
    static get CONVERT_TO_DROWNED(){ return 211; };
    static get BUCKET_FILL_FISH(){ return 212; };
    static get BUCKET_EMPTY_FISH(){ return 213; };
    static get UNDEFINED(){ return 214; };
  ...
  MobEffect: class extends Packet {
    ...
    static get LEVITATION(){ return 24; };
  ...
  PlayerAction: class extends Packet {
    ...
    static get SET_ENCHANTMENT_SEED(){ return 20; };
    static get START_SWIMMING(){ return 21; };
    static get STOP_SWIMMING(){ return 22; };
    static get START_SPIN_ATTACK(){ return 23; };
    static get STOP_SPIN_ATTACK(){ return 24; };
  ...
  Event: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "Event(entityId: " + this.entityId + ", eventId: " + this.eventId + ")";
    }
  ...
  CommandOutput: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "CommandOutput(originData: " + this.originData + ", outputType: " + this.outputType + ", successCount: " + this.successCount + ", messages: " + this.messages + ", unknown4: " + this.unknown4 + ")";
    }
  ...
  WSConnect: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "WSConnect(unknown0: " + this.unknown0 + ")";
    }
  ...
  RemoveObject: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "RemoveObject(objectName: " + this.objectName + ")";
    }
  ...
  SetDisplayObjective: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "SetDisplayObjective(displaySlot: " + this.displaySlot + ", objectiveName: " + this.objectiveName + ", displayName: " + this.displayName + ", criteriaName: " + this.criteriaName + ", sortOrder: " + this.sortOrder + ")";
    }
  ...
  SetScore: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "SetScore(type: " + this.type + ", scores: " + this.scores + ")";
    }
  ...
  LabTable: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "LabTable(unknown0: " + this.unknown0 + ", position: " + this.position + ", reactionType: " + this.reactionType + ")";
    }
  ...
  UpdateBlockSynced: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "UpdateBlockSynced(position: " + this.position + ", block: " + this.block + ", flagsAndMeta: " + this.flagsAndMeta + ", entityId: " + this.entityId + ", unknown4: " + this.unknown4 + ")";
    }
  ...
  MoveEntityDelta: class extends Packet {
    ...
    // flags
    static get HAS_DIFF_X(){ return 1; };
    static get HAS_DIFF_Y(){ return 2; };
    static get HAS_DIFF_Z(){ return 4; };
    static get HAS_ROT_X(){ return 8; };
    static get HAS_ROT_Y(){ return 16; };
    static get HAS_ROT_Z(){ return 32; };
    ...
    /** @return {string} */
    toString() {
      return "MoveEntityDelta(flags: " + this.flags + ", xDiff: " + this.xDiff + ", yDiff: " + this.yDiff + ", zDiff: " + this.zDiff + ", xRot: " + this.xRot + ", yRot: " + this.yRot + ", zRot: " + this.zRot + ")";
    }
  ...
  SetScoreboardIdentity: class extends Packet {
    ...
    // type
    static get REGISTER(){ return 0; };
    static get CLEAR(){ return 1; };
    ...
    /** @return {string} */
    toString() {
      return "SetScoreboardIdentity(type: " + this.type + ", registerEntries: " + this.registerEntries + ", clearEntries: " + this.clearEntries + ")";
    }
  ...
  SetLocalPlayerAsInitialized: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "SetLocalPlayerAsInitialized(entityRuntimeId: " + this.entityRuntimeId + ")";
    }
  ...
  UpdateSoftEnum: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "UpdateSoftEnum(name: " + this.name + ", values: " + this.values + ", type: " + this.type + ")";
    }
  ...
  NetworkStackLatency: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "NetworkStackLatency(timestamp: " + this.timestamp + ")";
    }
