...
const Play = {
  ...
  StartGame: class extends Packet {
    ...
    /** @return {string} */
    toString() {
      return "StartGame(entityId: " + this.entityId + ", runtimeId: " + this.runtimeId + ", gamemode: " + this.gamemode + ", position: " + this.position + ", yaw: " + this.yaw + ", pitch: " + this.pitch + ", seed: " + this.seed + ", dimension: " + this.dimension + ", generator: " + this.generator + ", worldGamemode: " + this.worldGamemode + ", difficulty: " + this.difficulty + ", spawnPosition: " + this.spawnPosition + ", loadedInCreative: " + this.loadedInCreative + ", time: " + this.time + ", version: " + this.version + ", rainLevel: " + this.rainLevel + ", lightningLevel: " + this.lightningLevel + ", multiplayerGame: " + this.multiplayerGame + ", broadcastToLan: " + this.broadcastToLan + ", broadcastToXbl: " + this.broadcastToXbl + ", commandsEnabled: " + this.commandsEnabled + ", textureRequired: " + this.textureRequired + ", gameRules: " + this.gameRules + ", bonusChestEnabled: " + this.bonusChestEnabled + ", startWithMapEnabled: " + this.startWithMapEnabled + ", trustPlayersEnabled: " + this.trustPlayersEnabled + ", defaultPermissionLevel: " + this.defaultPermissionLevel + ", xboxLiveBroadcastMode: " + this.xboxLiveBroadcastMode + ", serverChunkTickRadius: " + this.serverChunkTickRadius + ", levelId: " + this.levelId + ", worldName: " + this.worldName + ", premiumWorldTemplate: " + this.premiumWorldTemplate + ", unknown32: " + this.unknown32 + ", worldTicks: " + this.worldTicks + ", enchantmentSeed: " + this.enchantmentSeed + ")";
    }
